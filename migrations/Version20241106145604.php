 ...
 */
final class Version20241106145604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media_object ADD CONSTRAINT FK_14D43132FE52BF81 FOREIGN KEY (ads_id) REFERENCES ads (id)');
